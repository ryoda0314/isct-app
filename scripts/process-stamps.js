...
const OUT_DIR = path.resolve(__dirname, '..', 'public', 'stamps', 'reactions');
const CATEGORY = 'reactions';
const CATEGORY_LABEL = 'リアクション';
...
(async () => {
  ...
  // Write per-category manifest. The aggregate manifest at public/stamps/manifest.json
  // is regenerated by scripts/build-manifest.js after all category scripts run.
  const manifest = {
    category: CATEGORY,
