...
export const PomodoroView=({pomo,setPomo,mob})=>{
  ...
  return(
    <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:20}}>
      <div style={{fontSize:14,fontWeight:600,color:pomo.mode==="work"?T.accent:T.green,marginBottom:16}}>{pomo.mode==="work"?t("pomo.focus"):t("pomo.break")}</div>
      ...
      <div style={{marginTop:20,fontSize:13,color:T.txD}}>{t("pomo.completedSessions")}: <strong style={{color:T.txH}}>{pomo.sessions}</strong></div>
    </div>
  );
};
