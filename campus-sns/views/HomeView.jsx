          ...
          {portalData.sections?.map((sec,si)=>{
            ...
            return <div key={si} style={{marginBottom:20}}>
              ...
              <div style={{borderRadius:14,background:T.bg2,border:`1px solid ${T.bd}`,overflow:"hidden"}}>
                {sec.links.map((lnk,li)=><button key={li} onClick={()=>window.open("/api/portal/page?url="+encodeURIComponent(lnk.url),"_blank")} style={{width:"100%",display:"flex",alignItems:"center",gap:12,padding:"14px 16px",textDecoration:"none",border:"none",borderTop:li>0?`1px solid ${T.bd}`:"none",cursor:"pointer",background:"transparent",textAlign:"left",color:"inherit"}}>
