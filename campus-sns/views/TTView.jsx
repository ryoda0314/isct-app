      ...
      <div onClick={()=>{setCid(co.id);setCh("timeline");setView("course");}}
        ...
        <div style={{padding:mob?"6px 6px 5px":"10px 10px 8px",display:"flex",flexDirection:"column",height:"100%",justifyContent:"center"}}>
          ...
          <div style={{fontSize:mob?8:10,color:T.txD,marginTop:mob?2:4,opacity:.8}}>
            ...
            {co.bldg&&co.building&&<div onClick={e=>{e.stopPropagation();goToBuilding(co.building);}} style={{display:"inline-flex",alignItems:"center",gap:5,marginTop:4,padding:"6px 10px",borderRadius:8,background:"#14b8a650",color:"#14b8a6",fontWeight:700,cursor:"pointer",fontSize:16}}><svg width={14} height={14} viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5a2.5 2.5 0 010-5 2.5 2.5 0 010 5z"/></svg>{co.bldg}</div>}
          </div>
        </div>
