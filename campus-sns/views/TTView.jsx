      ...
      <div onClick={()=>{setCid(co.id);setCh("timeline");setView("course");}}
        ...
        <div style={{padding:mob?"6px 6px 5px":"10px 10px 8px",display:"flex",flexDirection:"column",height:"100%",justifyContent:"center"}}>
          ...
          <div style={{fontSize:mob?8:10,color:T.txD,marginTop:mob?2:4,display:"flex",alignItems:"center",gap:3,opacity:.8}}>
            ...
            <span>{co.room}{co.bldg&&co.building?<span onClick={e=>{e.stopPropagation();goToBuilding?.(co.building);}} style={{cursor:"pointer",textDecoration:"underline",textDecorationStyle:"dotted",textUnderlineOffset:2}}>{` (${co.bldg})`}</span>:co.bldg?` (${co.bldg})`:""}</span>
          </div>
        </div>
                ...
                <div key={`${pi}-${di}`} onClick={()=>{setCid(co.id);setCh("timeline");setView("course");}}
                  ...
                  <div style={{padding:"6px 5px 5px",display:"flex",flexDirection:"column",height:"100%",justifyContent:"center"}}>
                    ...
                    <div style={{fontSize:8,color:T.txD,marginTop:2,display:"flex",alignItems:"center",gap:2}}>
                      ...
                      {co.room}{co.bldg&&co.building?<span onClick={e=>{e.stopPropagation();goToBuilding?.(co.building);}} style={{textDecoration:"underline",textDecorationStyle:"dotted",textUnderlineOffset:2}}>{` (${co.bldg})`}</span>:co.bldg?` (${co.bldg})`:""}
                    </div>
                  </div>
          ...
          {curC.map(co=>{const n=cnt(co.id);return(
            <div key={co.id} onClick={()=>{setCid(co.id);setCh("timeline");setView("course");}}
              ...
              <div style={{flex:1,minWidth:0}}>
                ...
                <div style={{fontSize:10,color:T.txD}}>{co.code} · {co.per} · {co.room}{co.bldg&&co.building?<span onClick={e=>{e.stopPropagation();goToBuilding?.(co.building);}} style={{cursor:"pointer",textDecoration:"underline",textDecorationStyle:"dotted",textUnderlineOffset:2}}>{` (${co.bldg})`}</span>:co.bldg?` (${co.bldg})`:""}</div>
              </div>
          ...
          <div key={co.id} onClick={()=>{setCid(co.id);setCh("timeline");setView("course");}}
            ...
            <div style={{flex:1,minWidth:0}}>
              ...
              <div style={{fontSize:11,color:T.txD,marginTop:2,display:"flex",alignItems:"center",gap:4,flexWrap:"wrap"}}>
                ...
                <span>{co.per}</span><span>·</span><span>{co.room}{co.bldg&&co.building?<span onClick={e=>{e.stopPropagation();goToBuilding?.(co.building);}} style={{cursor:"pointer",textDecoration:"underline",textDecorationStyle:"dotted",textUnderlineOffset:2}}>{` (${co.bldg})`}</span>:co.bldg?` (${co.bldg})`:""}</span>
              </div>
            </div>
