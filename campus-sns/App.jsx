...
export default function App(){
  ...
  const mBack=goBack;
  return(
    <div ref={el=>{if(!el)return;const u=()=>{el.style.height=(isNative()?window.innerHeight:navigator.standalone?screen.height:window.innerHeight)+"px";};u();window.addEventListener("resize",u);}} style={{display:"flex",flexDirection:"column",width:"100%",overflow:"hidden",background:T.bg,color:T.tx,fontFamily:"'Inter',-apple-system,BlinkMacSystemFont,'Hiragino Sans','Segoe UI',sans-serif",position:"fixed",top:0,left:0,right:0}}>
