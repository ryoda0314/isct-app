...
export default function App(){
  ...
  const mBack=goBack;
  return(
    <div ref={el=>{if(!el||!isNative())return;const u=()=>{el.style.height=window.innerHeight+"px";};u();window.addEventListener("resize",u);}} style={{display:"flex",flexDirection:"column",width:"100%",overflow:"hidden",background:T.bg,color:T.tx,fontFamily:"'Inter',-apple-system,BlinkMacSystemFont,'Hiragino Sans','Segoe UI',sans-serif",position:"fixed",inset:0}}>
